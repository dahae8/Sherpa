...
print(new_data)
# '성별' 열의 내용을 수정
new_data['성별'] = new_data['성별'].replace({'1.남성': '남성', '2.여성': '여성', '3.기업': '기업'})
new_data['연령'] = new_data['연령'].replace({'0.기타': '기타', '1.10대': '10대', '2.20대': '20대', '3.30대': '30대',
                                         '4.40대': '40대', '5.50대': '50대', '6.60대': '60대', '7.70대이상': '70대이상'})
# 결과 출력
print(new_data)
